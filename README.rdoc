== twitter-text with customisable options {<img src="https://secure.travis-ci.org/twitter/twitter-text-rb.png" />}[http://travis-ci.org/twitter/twitter-text-rb] {<img src="https://codeclimate.com/badge.png" />}[https://codeclimate.com/github/twitter/twitter-text-rb]
...
This fork allows the gem to be used with sites other than Twitter i.e. if you use @ or # in your app, this fork will autolink to your app, not twitter.com

== App Configuration

This fork allows for configuration of default options via a Rails initializer

  Twitter.default_options = {
    :list_class     => "tweet-url list-slug",
    :username_class => "tweet-url username",
    :hashtag_class  => "tweet-url hashtag",
    :cashtag_class  => "tweet-url cashtag",

    :username_url_base => "https://twitter.com/",
    :list_url_base     => "https://twitter.com/",
    :hashtag_url_base  => "https://twitter.com/#!/search?q=%23",
    :cashtag_url_base  => "https://twitter.com/#!/search?q=%24",

    :invisible_tag_attrs => "style='position:absolute;left:-9999px;'"
  }
